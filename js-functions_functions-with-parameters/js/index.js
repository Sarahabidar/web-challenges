...
function greet(nameU) {
  console.log("Welcome " + nameU + ", good to see you again!");
}
greet("ALice");
...
This is repetitive code, so lets write a function 'logSeparator' which takes 
the number of the exercise as a parameter and logs the respective separator. 
...
// --v-- write your code here --v--
function logSeparator(taskNum) {
  console.log("console.log(-------------)");
  console.log("console.log(" + taskNum + ")");
}
logSeparator("Exercise 5");
// --^-- write your code here --^--

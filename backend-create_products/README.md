...
Your task is to refactor the app so that submitting the form creates a new entry in your Monnpm goDB and refreshes the page to show all products (including the new one).
